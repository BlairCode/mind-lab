...
| 主题 / 课程                  | 格式            | 描述                                                                                                                              | 状态     |
| :--------------------------- | :-------------- | :-------------------------------------------------------------------------------------------------------------------------------- | :------- |
| **数据结构 (Data Structure)** | `.xmind`, `.pdf` | 核心概念思维导图，结合《2026年数据结构考研复习指导》王道考研题目 (王彦芳&崔晗老师授课)                                            | ✅ 完成   |
| **深度学习 (Andrew Ng)** | `.xmind`, `.pdf` | 吴恩达 Coursera DL 课程思维导图，线上课程地址：[Bilibili](https://www.bilibili.com/video/BV1FT4y1E74V/)                          | ✅ 完成   |
| **深度学习 (Koki Saitoh)** | `.xmind`, `.pdf` | 斋藤康毅 DL 书籍学习思维导图，原书：《深度学习入门：基于Python的理论与实现》，电子书：[zlibrary](https://z-lib.gd/book/5330695/f3624e/%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%E5%85%A5%E9%97%A8%E5%9F%BA%E4%BA%8Epython%E7%9A%84%E7%90%86%E8%AE%BA%E4%B8%8E%E5%AE%9E%E7%8E%B0.html) | ✅ 完成   |
| **计算机组成与体系结构** | `.xmind`        | 结合《2026年计算机组成原理考研复习指导》王道考研题目 (黄倩&谢在鹏&周小伟老师授课)                                                 | 🚧 进行中 |
...
| 主题 / 课程      | 格式  | 描述                 | 状态     |
| :--------------- | :---- | :------------------- | :------- |
| **大学物理** | `.pdf` | 大学物理笔记 (丁万平老师授课) | ✅ 完成   |
| **计算方法与实习** | `.pdf` | 计算方法与实习笔记     | ✅ 完成   |
| **离散数学** | `.pdf` | 离散数学笔记 + 期末复习知识提炼笔记 | ✅ 完成   |
| **概率论** | `.pdf` | 概率论笔记 (王启明老师授课) | ✅ 完成   |

### 🌐 跨领域探索

| 主题 / 课程 | 格式            | 描述                       | 状态     |
| :---------- | :-------------- | :------------------------- | :------- |
| **香水学 (Perfumery)** | `.xmind`, `.pdf` | Perfumery Appreciation 《香水之书》学习思维导图 | ✅ 完成   |
